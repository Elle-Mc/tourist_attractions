...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { location: @attraction.location, place: @attraction.place, went: @attraction.went } }, as: :json
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { location: @attraction.location, place: @attraction.place, went: @attraction.went } }, as: :json
    assert_response 200
  end
